...
| 10 | v0.1.0 | 开箱 + 组件确认 + 照片归档 | 30min | 板子 | 🔵 等待板子 |
| 11 | v0.1.1 | GPIO 引脚表确认 (说明书→MD) | 30min | 板子 | ⬜ |
| 12 | v0.1.2 | Kconfig 引脚默认值更新 + menuconfig | 20min | 板子 | ⬜ |
| 13 | v0.1.3 | 首次编译烧录 + 串口启动日志验证 | 30min | 板子 | ⬜ |
| 14 | v0.1.4 | 显示屏背光 + SPI + LVGL 渲染 | 45min | 板子 | ⬜ |
