...
| 8 | v0.0.8 | 音频 I/O + 触摸驱动实现 | 45min | 无 | ✅ 完成 |
| 9 | v0.0.9 | 系统集成 + 健康监控 | 45min | 无 | ✅ 完成 |
| 10 | v0.1.0 | 开箱 + 组件确认 + 照片归档 | 30min | 板子 | ✅ 完成 |
| 11 | v0.1.1 | GPIO 引脚表确认 (说明书→MD) | 30min | 板子 | ✅ 完成 |
| 12 | v0.1.2 | Kconfig 引脚默认值更新 + menuconfig | 20min | 板子 | ✅ 完成 |
| 13 | v0.1.3 | 首次编译烧录 + 串口启动日志验证 | 30min | 板子 | ✅ 完成 |
| 14 | v0.1.4 | 显示屏背光 + SPI + LVGL 渲染 | 45min | 板子 | ✅ Codex 修复 |
| 15 | v0.1.5 | 触摸驱动确认 + 原始坐标数据 | 30min | 板子 | ⬜ |
| 16 | v0.1.6 | 触摸校准 + 文本输入可用 | 30min | 板子 | ⬜ |
| 17 | v0.1.7 | WiFi 连接 + IP 获取 | 20min | 板子 | ⬜ |
| 18 | v0.1.8 | 首次 AI 对话 ("你好" → 流式回复) | 30min | 板子 | ⬜ |
| 19 | v0.1.9 | UI 打磨 + 异常处理 + 稳定性 | 2h | 板子 | ⬜ |
| 20 | v0.2.0 | OV5640 I2C 通信验证 | 1h | 板子+摄像头 | ⬜ |
| 21 | v0.2.1 | DVP + DMA 原始帧采集 | 2h | 板子+摄像头 | ⬜ |
| 22 | v0.2.2 | 首张 JPEG 照片 | 1h | 板子+摄像头 | ⬜ |
| 23 | v0.2.3 | TF 卡挂载 + 文件读写 | 1h | 板子+TF卡 | ⬜ |
| 24 | v0.2.4 | #photo 命令集成 | 1.5h | 全部 | ⬜ |
...
```
v0.0.1 ✅ → v0.0.2 ✅ → v0.0.3 ✅ → v0.0.4 ✅ → v0.0.5 ✅ → v0.0.6 ✅ → v0.0.7 ✅ → v0.0.8 ✅ → v0.0.9 ✅   [板子到货前 100%]
                                            │
                                            ▼
...
| v0.0.8 | 2026-06-08 | 2026-06-08 | ✅ | ✅ | 音频 I/O + 触摸驱动 |
| v0.0.9 | 2026-06-08 | 2026-06-08 | ✅ | ✅ | 系统集成 + CodeWhale/Reasonix/Hermes 审计 |
| v0.1.0 | 2026-06-13 | 2026-06-13 | ✅ | ✅ | 拍照归档完成 |
| v0.1.1 | 2026-06-13 | 2026-06-13 | ✅ | ✅ | GPIO 提取自 xiaozhi-esp32 |
| v0.1.2 | 2026-06-13 | 2026-06-13 | ✅ | ✅ | Kconfig + sdkconfig 更新 |
| v0.1.3 | 2026-06-13 | 2026-06-13 | ✅ | ✅ | 编译成功，ESP-IDF v5.2.7 |
| v0.1.4 | 2026-06-13 | 2026-06-13 | ✅ | ✅ | Codex CX-9: esp_lcd ST7789 |
| v0.1.5 | — | — | ⬜ | ⬜ | 等板子 |
| v0.1.6 | — | — | ⬜ | ⬜ | 等板子 |
| v0.1.7 | — | — | ⬜ | ⬜ | 等板子 |
| v0.1.8 | — | — | ⬜ | ⬜ | 等板子 |
